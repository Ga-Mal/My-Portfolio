...
const projects = [
  ...
  },
  {
    title: "Hospital",
    description:
      "The website was designed using only HTML, CSS, and SCSS, and its purpose was to demonstrate my ability to write a large script for a beginner.",
    src: Hospitalimg,
    link: Hospitalimg,
    color: "#5196fd",
    githubLink: "https://github.com/Ga-Mal/Hospital_UI",
    liveLink: "https://hospital-u.netlify.app/",
  },
  {
    title: "Resturant UI ",
    description:
      "The website is purely a front-end interface, created as a practice project to learn Bootstrap and some icon libraries.",
    src: Resturantimg,
    link: Resturantimg,
    color: "#8f89ff",
  ...
  return (
    <div
      ...
      <motion.div
        ...
        <div className="w-full mt-20 flex flex-col md:flex-row bg-zinc-900 rounded-2xl overflow-hidden shadow-xl">
